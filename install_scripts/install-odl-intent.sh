...
sshpass -p karaf ssh -n -p 8101 -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no karaf@localhost "feature:install odl-vpnservice-intent odl-dlux-all"
